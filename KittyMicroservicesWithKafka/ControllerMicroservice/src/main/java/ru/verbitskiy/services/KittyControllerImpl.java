...
public class KittyControllerImpl implements KittyController {
    ...
    @Autowired
    public KittyControllerImpl(KittyDataService kittyDataService, KittyControllerMapper kittyControllerMapper) {
        kitty_data = kittyDataService;
        this.mapper = kittyControllerMapper;
    }
